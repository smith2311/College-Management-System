...
public class Faculty_Change_Pwd extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.faculty_change_pwd,container,false);
    ...
    private void change_pwd() {
        ...
        pd.setMessage("Faculty Changing Password.....");
        pd.setIndeterminate(false);
        pd.setCancelable(false);
        pd.show();


        StringRequest sr = new StringRequest(Request.Method.POST, IPConfig.url + "faculty_change_pwd",
    ...
    private void openchangepwd() {
        Fragment fragment3 = new Faculty_Change_Pwd();
